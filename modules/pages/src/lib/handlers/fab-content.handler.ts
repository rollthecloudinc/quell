...
export class FabContentHandler implements ContentHandler {
  ...
  toObject(settings: Array<AttributeValue>): Observable<Fab> {
    return of(new Fab(this.attributeSerializer.deserializeAsObject(settings)));
  }

  buildSettings(button: Fab): Array<AttributeValue> {
