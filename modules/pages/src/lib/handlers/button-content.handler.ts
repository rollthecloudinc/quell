...
export class ButtonContentHandler implements ContentHandler {
  ...
  toObject(settings: Array<AttributeValue>): Observable<QButton> {
    return of(new QButton(this.attributeSerializer.deserializeAsObject(settings)));
  }

  buildSettings(button: QButton): Array<AttributeValue> {
