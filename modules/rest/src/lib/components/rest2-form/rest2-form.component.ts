...
@Component({
  selector: 'classifieds-ui-rest2-form',
  templateUrl: './rest2-form.component.html',
  styleUrls: ['./rest2-form.component.scss']
})
export class Rest2FormComponent implements OnInit, AfterViewInit {
