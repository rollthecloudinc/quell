...
Quell is a Content Mannagement Framework inspired by Drupal. Many of same concepts have been implemented such as; panel pages (first classs citizens), fields (dynamic form buillding), contexts, plugins. The systsem also operates on the open-close model via extension using native federation to supply your own plugins others can use without core mods.
